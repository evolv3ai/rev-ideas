...
class MCPWorkflow:
    ...
    def run_code_quality_workflow(self, code_path: str) -> Dict[str, Any]:
        ...
        format_result = self.execute_tool("format_check", {
            "path": code_path,
            "language": "python"
        })
        ...
        ai_result = self.execute_tool("consult_gemini", {
    ...
    def generate_documentation_workflow(self, project_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        doc_result = self.execute_tool("compile_latex", {
        ...
        viz_result = self.execute_tool("create_manim_animation", {
            "script": manim_script,
            "output_format": "mp4"
        })
...
def main():
    ...
    ai_structure = workflow.execute_tool("consult_gemini", {
